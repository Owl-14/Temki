...
Страница: `pages/hatch-rules.html` — ссылка справа от кнопки «Отметить вылупление» на `edit-egg.html`.

### Обязательно (создатель)

- Заполнено поле **«Ссылка»** или **«Демо / продукт»** — внешний продукт, не канал «о проекте».
