import { auth, onAuthStateChanged, getUserProfile, fetchUserEggs, redirectIfUnverified } from '../core/firebase-app.js';
import { fetchEggQuestions } from '../platform/platform-api.js';
...
function renderEggDashboard(egg, stats) {
  return '<article class="my-egg-card">' +
    ...
    '<p class="my-egg-card__meta">❓ ' + stats.unanswered + ' вопросов без ответа</p>' +
